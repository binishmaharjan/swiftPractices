...
SWIFT_CLASS("_TtC7Example14NetworkCapture")
@interface NetworkCapture : NSURLProtocol
/// Determines whether the protocol subclass can handle the specified request.
/// \param request a urlRequest
///
///
/// returns:
/// if return true here, this class will be instantiated and used
...
///
/// returns:
/// returns the proccessed request if needed, otherwise just return the original request
...
/// \param lhs first urlRequest
///
/// \param rhs the second urlRequest
///
///
/// returns:
/// true if we need caching, if we don’t need any caching, just return false
+ (BOOL)requestIsCacheEquivalent:(NSURLRequest * _Nonnull)lhs toRequest:(NSURLRequest * _Nonnull)rhs SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC7Example13SceneDelegate")
